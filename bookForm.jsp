...
<body>
    <%
        ...
        if (user == null) {
            String redirectTo = "book?action=new";
            session.setAttribute("redirectURL", redirectTo);
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="login?redirect=book%3Faction%3Dnew">
    ...
    <main class="container">
        <div class="content-card">
            ...
            <form id="addBookForm" action="book" method="post">
                ...
                <input type="hidden" id="currentYear" value="<%= java.time.Year.now().getValue() %>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const currentYearValue = parseInt(document.getElementById('currentYear').value);
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (pubYear.value) {
                    if (pubYear.value < 1000 || pubYear.value > currentYearValue) {
